...
// I'm going to change the interface to this class, I want it to be the same as the DBR class interface
// input min_feature_size, resonance wavelength, wavelength, neff, grp index
// I'm going to deprecate this version of the code, I don't want to delete it until I know the other version works
// R. Sheehan 11 - 5 - 2019
